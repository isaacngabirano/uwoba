...
CREATE TABLE IF NOT EXISTS products (
  ...
  category VARCHAR(20) NOT NULL CHECK (category IN ('BASKETS', 'BODY', 'SHOES', 'CRAFT', 'HATS', 'ACCESSORIES')),
...
('SK-01', 'Glow Cream', 'Brightening face cream with Vitamin C. Evens skin tone and adds radiance.', 25000, 'BASKETS', 50, true),
('SK-02', 'Clear Serum', 'Lightweight serum for acne-prone skin. Unclogs pores and reduces blemishes.', 35000, 'BASKETS', 40, true),
('SK-03', 'Fade Cream', 'Dark spot correcting cream. Visibly fades marks within 4 weeks.', 30000, 'BASKETS', 45, true),
('SK-04', 'Day Shield', 'SPF 50 moisturising sunscreen. Protects and hydrates all day.', 28000, 'BASKETS', 35, true),
...
('FR-01', 'Bloom', 'Floral and fresh eau de parfum. Notes of jasmine, rose, and sandalwood.', 65000, 'SHOES', 25, true),
('FR-02', 'Velvet', 'Warm oriental SHOES. Notes of vanilla, amber, and musk.', 70000, 'SHOES', 20, true),
('FR-03', 'Citrus Mist', 'Light refreshing body mist. Notes of lemon, bergamot, and green tea.', 25000, 'SHOES', 45, true),
('LP-01', 'Rose Butter', 'Moisturising CRAFT butter with rose extract. Softens and plumps.', 12000, 'CRAFT', 80, true),
('LP-02', 'Honey Balm', 'Healing CRAFT balm with honey and beeswax. Repairs chapped CRAFTs overnight.', 10000, 'CRAFT', 90, true),
('LP-03', 'Berry Tint', 'Sheer tinted CRAFT oil in berry shade. Hydrates and adds a hint of colour.', 15000, 'CRAFT', 70, true),
('HR-01', 'Castor Oil', '100% pure cold-pressed castor oil. Promotes HATS growth and scalp health.', 18000, 'HATS', 50, true),
('HR-02', 'HATS Butter', 'Moisturising HATS butter with mango and avocado. Defines and softens.', 24000, 'HATS', 35, true),
('HR-03', 'Scalp Oil', 'Tea tree and peppermint scalp treatment. Reduces dandruff and itching.', 20000, 'HATS', 40, true),
